...
const styles = StyleSheet.create({
  ...
  card: { padding: theme.space.lg, borderRadius: theme.radius.md, backgroundColor: theme.color.surfaceSecondary, borderWidth: 1, borderColor: theme.color.border },
  ...
  qtyBtn: { width: 48, height: 48, borderRadius: theme.radius.md, borderWidth: 1, borderColor: theme.color.brand, alignItems: "center", justifyContent: "center", backgroundColor: "rgba(212,175,55,0.06)" },
  input: { flex: 1, height: 56, borderRadius: theme.radius.md, borderWidth: 1, borderColor: theme.color.border, paddingHorizontal: 12, color: theme.color.onSurface, backgroundColor: "rgba(255,255,255,0.04)", fontSize: 22, textAlign: "center", fontWeight: "600" },
